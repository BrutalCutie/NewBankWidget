from src.widget import get_masked_data, get_date
from src.processing import get_state, get_by_date_operations
...
example = [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
